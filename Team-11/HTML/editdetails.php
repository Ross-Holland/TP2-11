...
if ($user) {
    ...
    echo "<form action='updateuserdetails.php' method='post'>";
    ...
    echo "<label>Email Address:</label><input type='email' name='email' value='".$user['user_email']."' required><br>";
    echo "<label>Address:</label><input type='text' name='address' id='Address' value='".$user['user_address']."' required><br>";
    echo "<label>Password: (Input 0 to keep your original password) </label><input type='password' name='password' value='' required><br>";
