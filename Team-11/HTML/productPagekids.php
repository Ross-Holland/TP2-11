        ...
        <main>
            ...
            <div class="category">
                <div class="category">
                    ...
                    <button class="centered" onclick="document.location='productPagekids.php?category=14'">Kids
                        Boots</button>
                </div>
                <div class="category">
                    <img src="../Images/kidshightops.jpg" alt="high-tops" />
                    <button class="centered" onclick="document.location='productPagekids.php?category=15'">High
                        Tops</button>
                </div>
                <div class="category">
                    <img src="../Images/kidsmartshoe.jpg" alt="kidsmartshoe" />
                    <button class="centered" onclick="document.location='productPagekids.php?category=16'">smart
                        shoes</button>
                </div>
                <div class="category">
                    <img src="../Images/trainerskids.jpg" alt="trainers" />
                    <button class="centered"
                        onclick="document.location='productPagekids.php?category=17'">Trainers</button>
                </div>
                <div class="category">
                    <img src="../Images/slipperskid.jpg" alt="slippers" />
                    <button class="centered"
                        onclick="document.location='productPagekids.php?category=18'">Slippers</button>
                </div>
            </div>
